...
class ListPropertyPage extends Component {
  ...
  componentDidMount() {
    axios
      .get("https://private-12204a-gasti.apiary-mock.com/v1/property")
      .then((res) => {
    ...
    return (
      <div className="row">
        ...
        <div className="col-md-9">
          <p className="margin0" style={{ fontWeight: "bold" }}>
            {cell.name}
          </p>
          <StarRatingRender
            stars={4}
    ...
    return (
      <Row>
        <Col>
          ...
          <p className="text-muted">{cell.package}</p>
        </Col>
      </Row>
    );
  };
    ...
    return (
      <Row>
        <Col>
          ...
          <p className="text-muted">Barang</p>
        </Col>
      </Row>
    );
  };
    ...
    return (
      <Row>
        <Col>
          ...
          <p className="text-muted">Orang</p>
        </Col>
      </Row>
    );
  };
      ...
      <div className="page">
        <Container>
          ...
          <Row className="align-items-center page-row">
            <Col>
              <h1 className="page-title" style={{ marginLeft: "-1rem" }}>
                Daftar Gudang
              </h1>
            </Col>
            <Col>
          ...
          <Row>
            <Col className="table-box">
              ...
              <Row>
                <BootstrapTable tableHeaderClass="table-header" tableStyle={{ border: "none" }} data={property} selectRow={selectRowProp} pagination={true} options={options} bordered={false} >
                  <TableHeaderColumn tdAttr={{ colSpan: 2 }} colSpan="2" dataField="detail" dataFormat={this.detailFormatter} isKey >
                    Nama Gudang
                  </TableHeaderColumn>
                  <TableHeaderColumn dataField="renter" dataFormat={this.renterFormatter} >
                    Penyewa
                  </TableHeaderColumn>
                  <TableHeaderColumn dataField="stock" dataFormat={this.stockFormatter} dataSort={true} >
                    Stock
                  </TableHeaderColumn>
                  <TableHeaderColumn dataField="staff" dataFormat={this.staffFormatter} dataSort={true} >
                    Jumlah Staff
                  </TableHeaderColumn>
                  <TableHeaderColumn dataField="action" dataFormat={this.actionFormatter} >
                    Action
                  </TableHeaderColumn>
                </BootstrapTable>
              </Row>
