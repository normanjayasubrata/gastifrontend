...
const Services = (props) => {
  const { windowHeight, windowWidth, isNotMobile } = props.windowSize;
  ...
  const divStyleFull = {
    ...
    backgroundColor: "#DCDCDC", height: windowHeight,
  }
            ...
            {infos.map((info, index) => (
              <Card key={index} style={{ width: "28.875rem", height: "28.125rem", margin: "1rem", border: "solid #B4B4B4 2px"}}>
                ...
                <Card.Body>
                  ...
                  <Button variant="outline-primary" style={{fontSize: "1rem", borderColor: "#00C9A7", color: "#00C9A7", width: "10.875rem", height: "3.125rem", marginTop: "1rem"}} >{info.button}</Button>
                </Card.Body>
              </Card>
            ))}
          </Row>
